...
{
	[AutoloadHead]
	public class Declan : ModNPC
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Lost Hero");
		}
		...
		{                                           //npc chat
			...
			switch (Main.rand.Next(11))
			{
				...
				case 2:
					return "How about some nice Bubbles right there?";
				case 3:
					return "Does this room need more Jellyfish?";
				case 4:
					return "How about Squidward?";
				case 5:
					return "Wanna take a look at my wares?";
				case 6:
					return "This one decoration here, it fits right into your room";
				case 7:
					return "This place could use some Chests...";
				case 8:
					return "My glasses look dirty... lemme clean em really quick...";
				case 9:
					return "Looks like you came for another demon aye?";
				case 10:
