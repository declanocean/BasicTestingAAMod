...
{
	[AutoloadHead]
	public class BonkersNice : ModNPC
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Hammerila");
		}
		...
		{                                           //npc chat
			...
			switch (Main.rand.Next(11))
			{
				...
				case 2:
					return "How about some nice Hammer right there?";
				case 3:
					return "Does this room need more Ranks?";
				case 4:
					return "How about Blank?";
				case 5:
				...
				case 9:
					return "Looks like you came for another talk?";
				case 10:
